...
import com.pms.service.impl.KeyValueServiceImpl;
...
public class KeyValueController {
  ...
  @ResponseBody
  public int changeWageItem(
      double late_buckle_pay,
      double early_buckle_pay,
      double missionallowance,
      double full_attendance_pay,
      double food_pay,
      double traffic_pay)
      throws Exception {
