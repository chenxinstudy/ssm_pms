...
/**
 * @Author: cx @Date: 2022/3/10 15:19
 */
@Controller
...
public class EmployeeController {
  ...
  @Autowired private EmployeeCustomVoMapper employeeCustomVoMapper;
  ...
  public EmployeePages findSelective(
    ...
    List<EmployeeCustomVo> list = employeeCustomVoMapper.selectEmployeeSelective(map);
